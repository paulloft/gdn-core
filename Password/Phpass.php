 ...
 */
class Phpass implements Password {
     ...
     */
    public function __construct($hashMethod = Phpass::HASH_PHPASS, $iteration_count_log2 = 8) {
     ...
     * @return Phpass Returns $this for fluent calls.
     */
